...
titleSearch::titleSearch(QDialog *parent) : QDialog(parent)
{
	ui.setupUi(this);
...
void titleSearch::entered() {
	saveTxt();
	QProcess::execute("./guiQuery.exe");	//阻塞调用
	getTxt();
}

void titleSearch::saveTxt() {
	QString filePath = "./query2.txt";
	QFile file(filePath);
...
void titleSearch::getTxt() {
	QTextCodec *codec = QTextCodec::codecForName("GB2312");
	QString filePath = "./result2.txt";
	QFile file(filePath);
...
void titleSearch::button1clicked() {
...
void titleSearch::button2clicked() {
...
void titleSearch::button3clicked() {
...
void titleSearch::button4clicked() {
...
void titleSearch::button5clicked() {
